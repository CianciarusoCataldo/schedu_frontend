...
/**
 * This page let the user to load his data (manually, with json, or csv) and process it with the
 * dispatcher. It contains a table with the data to process, and shows the result on the bottom
 */
